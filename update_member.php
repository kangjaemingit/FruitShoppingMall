...
<body>
    ...
    <form method = "post" action = "update_member_confirm.php">;
        <h2 style ="background-color:lightgray; text-align : center;">내 정보 수정</h2>
        <div class="input-group mb-3">
            <label for="mem_id">아이디 </label>
            <input type="id" class="form-control" name = "mem_id" id="mem_id" placeholder="Enter ID" value = '<?php echo $mem_id;?>' disabled>
        </div>
        <div class="input-group mb-3">
